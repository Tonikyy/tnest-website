...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white shadow-sm border-b sticky top-0 z-50 transition-colors duration-200">
            ...
            {session ? (
              <>
                <Link
                  ...
                  className="text-text-primary dark:text-gray-200 hover:text-primary dark:hover:text-primary px-3 py-2 rounded-md text-sm font-medium transition-colors"
                >
                  Dashboard
                </Link>
                <Link
